    ...
    grunt.initConfig({
        ...
        uglify: {
            ...
            channel: {
                ...
                src: 'public/static/channel/dist/<%= pkg.version %>/<%= pkg.name %>.js',
                dest: 'public/static/channel/dist/<%= pkg.version %>/<%= pkg.name %>.min.js'
            },
            store: {
                options: {
                    banner: '/*! <%= pkg.name %> <%= grunt.template.today("yyyy-mm-dd") %> */\n'
                },
                src: 'public/static/store/dist/<%= pkg.version %>/<%= pkg.name %>.js',
                dest: 'public/static/store/dist/<%= pkg.version %>/<%= pkg.name %>.min.js'
            },
            admin: {
                options: {
                    banner: '/*! <%= pkg.name %> <%= grunt.template.today("yyyy-mm-dd") %> */\n'
