<div class="section" ng-controller="RecipeNewCtrl">

    <p class="caption">Formulário para cadastro de novas receitas</p>
                    ...
                    <form class="col s12">
                        ...
                        <div class="row">
                            <div class="input-field col s12 m6 l6">
                                <select ng-model="recipe.channel_id" id="input1" class="browser-default"
                                        ng-options="channel.id as channel.name for channel in ::channels">
                                    <option value=""></option>
                                </select>
                ...
                <div class="row">
                    <form class="col s12">
                        ...
                        <div style="margin-bottom: 5px;" class="row" ng-repeat="product in recipe.products">
                            <div class="input-field col s12 m12 l12">
                                <select ng-model="product.product_id" id="product{{$index}}" class="browser-default"
